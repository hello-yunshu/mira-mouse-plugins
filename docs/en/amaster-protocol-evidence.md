...
| AM35 named mouse modes 0/1/2 | `disassembly/AM35model.dis`; reverse analysis | steady/breathing/mode 2 (neutralized; reverse engineering name 'neon' has unconfirmed write behavior) | medium | source-confirmed; mode 2 write unknown |
