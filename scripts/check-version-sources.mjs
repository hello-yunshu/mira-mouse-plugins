...
if (!ciYmlRaw.includes('FALLBACK_HOST_SHA="6487ac389f92cccfd86d27a77aa99677692b2871"')) {
  throw new Error('.github/workflows/ci.yml must pin the confirmed-compatible Host commit');
}
